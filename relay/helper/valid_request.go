...
// GetAndValidateAlphaSearchRequest parses the standalone Codex web search
// request (/v1/alpha/search). The raw body is preserved so unknown fields are
// forwarded intact to upstream. Mirrors new-api-reference/relay/helper/valid_request.go.
