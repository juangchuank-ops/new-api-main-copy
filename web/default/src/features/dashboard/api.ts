...
// Throws an Error when the backend returns { success: false, message } so
// callers can surface the error instead of silently rendering empty charts.
export async function getUserQuotaDates(
  ...
  return res.data as { success: true; data: QuotaDataItem[] }
}
...
export async function getFlowQuotaDates(
  ...
  return res.data as { success: true; data: FlowQuotaDataItem[] }
}
