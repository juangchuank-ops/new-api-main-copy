...
export type HeaderNavModulesConfig = {
  ...
  modelAvailability: HeaderNavAccessConfig
  docs: boolean
  about: boolean
...
const cloneHeaderNavDefault = (): HeaderNavModulesConfig => ({
  ...
  modelAvailability: { ...HEADER_NAV_DEFAULT.modelAvailability },
})
...
export function parseHeaderNavModules(
  ...
  try {
    ...
    const result: HeaderNavModulesConfig = {
      ...
      modelAvailability: { ...base.modelAvailability },
    }
    ...
    Object.entries(parsed).forEach(([key, raw]) => {
      ...
      if (key === 'modelAvailability') {
        result.modelAvailability = parseAccessModule(
          raw,
          base.modelAvailability
        )
        return
      }
