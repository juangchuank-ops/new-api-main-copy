    ...
    <SettingsSection title={t('Basic Authentication')}>
      <Form {...form}>
        <SettingsForm onSubmit={form.handleSubmit(onSubmit)}>
            ...
            render={({ field }) => (
              <SettingsSwitchItem>
                <SettingsSwitchContent>
                  ...
                  <FormDescription>
                    {t('Require invitation code for new registrations')}
                  </FormDescription>
                </SettingsSwitchContent>
                <FormControl>
                  <Switch
          ...
          <FormField
            control={form.control}
            name='InvitationCodePrice'
            render={({ field }) => (
              <FormItem className='px-0.5'>
                <FormLabel>{t('Invitation Code Price')}</FormLabel>
                <FormControl>
                  <Input
                    type='number'
                    min={0}
                ...
                <FormDescription>
                  {t('Unit price for invitation code purchases (in your currency)')}
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
