        ...
        <div className='mb-3 sm:mb-4'>
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isMatched && 'border-[#7A9E6D]/40 bg-[#7A9E6D]/10'
                  )}
                >
                  <div className='mb-1.5 flex flex-wrap items-center gap-1.5'>
                    ...
                    {isMatched && (
                      <Badge
                        variant='secondary'
                        className='bg-[#F0F5EE] text-[#5A8A6B] dark:bg-[#3A5A4B]/20 dark:text-[#7AB89A]'
                      >
                        {t('Matched')}
                      </Badge>
                    )}
          ...
          <StaticDataTable
            ...
            getRowClassName={(tier) => {
              ...
              return cn(
                isMatched &&
                  'bg-[#F0F5EE]/70 hover:bg-[#F0F5EE]/70 dark:bg-[#3A5A4B]/10 dark:hover:bg-[#3A5A4B]/10'
              )
            }}
            columns={[
              {
