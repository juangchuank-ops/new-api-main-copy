...
): Promise<InvitationCodeCheckResponse> {
  const res = await api.get<InvitationCodeCheckResponse>(
    '/api/invitation-code/check',
    {
      params: { key: invitationCode },
