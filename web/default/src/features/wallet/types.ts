...
export interface CreemPaymentRequest {
  /** Creem product ID; invitation-code purchases use the configured default */
  product_id?: string
  /** Payment method identifier */
  payment_method: 'creem'
  /** Product type for non-topup purchases */
  product_type?: string
  /** Item count for non-topup purchases */
  count?: number
}

/**
 * Invitation code payment request for Stripe/Creem/Waffo/WaffoPancake endpoints
 */
export interface InvitationCodePaymentRequest {
  /** Product type identifier */
  product_type: string
  /** Number of invitation codes to purchase */
  count: number
}
...
export interface PaymentRequest {
  ...
  /** Product type for non-topup purchases (e.g. 'invitation_code') */
  product_type?: string
  /** Item count for non-topup purchases */
  count?: number
}
...
/** Invitation code owned by the current user */
...
export interface UserInvitationCodesPage {
  items: UserInvitationCode[]
  total: number
  page: number
  page_size: number
}
