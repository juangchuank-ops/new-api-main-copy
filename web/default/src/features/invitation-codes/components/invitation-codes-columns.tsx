...
import { INVITATION_CODE_STATUSES } from '../constants'
  ...
  return [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        const statusConfig = INVITATION_CODE_STATUSES[statusValue]
