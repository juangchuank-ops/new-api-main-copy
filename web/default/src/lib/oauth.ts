 ...
 * Includes invitation code if provided (required when invitation codes are enabled)
 */
export async function getOAuthState(invitationCode?: string): Promise<string | null> {
  try {
