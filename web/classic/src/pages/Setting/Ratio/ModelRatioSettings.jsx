...
import PricingPatchDialog from './components/PricingPatchDialog';
...
export default function ModelRatioSettings(props) {
  ...
  const [showPricingPatch, setShowPricingPatch] = useState(false);
    ...
    <Spin spinning={loading}>
      ...
      <Space style={{ marginTop: 10 }}>
        <Button
          theme='borderless'
          type='primary'
          onClick={() => setShowPricingPatch(true)}
        >
          {t('Pricing Patch')}
        </Button>
      </Space>
      <PricingPatchDialog
        visible={showPricingPatch}
