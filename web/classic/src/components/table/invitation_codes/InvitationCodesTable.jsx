...
import DeleteInvitationCodeModal from './modals/DeleteInvitationCodeModal';

const InvitationCodesTable = (invitationCodesData) => {
  const {
    invitationCodes,
    loading,
    activePage,
  ...
  const showDeleteInvitationCodeModal = (record) => {
