...
// GetRedemptionsForExport retrieves redemptions for CSV export.
// When ids is non-empty, only those redemptions are returned (keyword/status ignored).
// When applyFilters is true, keyword and status filters are applied.
