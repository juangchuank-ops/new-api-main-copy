...
// appendUserAgentToOther 将客户端 User-Agent 写入日志 Other JSON（键 "ua"），
// 用于使用日志表展示；超长截断避免异常 UA 撑大 other 字段。
func appendUserAgentToOther(c *gin.Context, other map[string]interface{}) map[string]interface{} {
	if other == nil {
