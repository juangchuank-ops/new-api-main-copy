...
func SetTaskRouter(router *gin.Engine) {
	...
	taskSubmitRouter.Use(middleware.RouteTag("relay"), middleware.TokenAuth(), middleware.RelayAutoBanClientMetrics(), middleware.RelayUserAgentBlacklist(), middleware.SystemPerformanceCheck(), middleware.UserRequestRateLimit())
	{
	...
	taskReadRouter.Use(middleware.RouteTag("relay"), middleware.TokenAuth(), middleware.RelayAutoBanClientMetrics(), middleware.RelayUserAgentBlacklist())
	{
