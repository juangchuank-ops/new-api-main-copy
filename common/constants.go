...
const (
	RoleGuestUser       = 0
	RoleCommonUser      = 1
	RolePermissionAdmin = 5
	RoleAdminUser       = 10
	RoleRootUser        = 100
)

func IsValidateRole(role int) bool {
	return role == RoleGuestUser || role == RoleCommonUser || role == RolePermissionAdmin || role == RoleAdminUser || role == RoleRootUser
}
