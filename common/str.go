...
// StringToByteSlice converts string to []byte safely.
// This creates a copy to avoid unsafe pointer manipulation.
...
func MaskSensitiveInfo(str string) string {
	...
	// Mask API keys (e.g., "api_key:AIza<google-api-key>" -> "api_key:***")
