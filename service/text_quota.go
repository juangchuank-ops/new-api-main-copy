...
func PostTextConsumeQuota(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, usage *dto.Usage, extraContent []string) {
	originUsage := usage
	billingUsage := effectiveBillingUsageFromOldDto(usage)
	if usage == nil {
	...
	appendUsageBillingPathForLogFromOldDto(other, common.GetContextKeyBool(ctx, constant.ContextKeyLocalCountTokens), originUsage)
